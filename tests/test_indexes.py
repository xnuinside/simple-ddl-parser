...
def test_several_indexes_types():
    ...
    CREATE UNIQUE INDEX i3 ON sqlserverlist (delete_date DESC, create_date ASC, ending_funds  DESC); --- This line is commented because TSQL doesnt allow two index on table added as an example
 ...
 'tables': [{'alter': {},
             ...
             'index': [{'clustered': False,
                       ...
                       {'clustered': True,
                        ...
                        'detailed_columns': [{'name': 'delete_date',
                                              'nulls': 'LAST',
                                              'order': 'ASC'},
                                             {'name': 'create_date',
                                              'nulls': 'LAST',
...
def test_clustered_index():
 ...
 'tables': [{'alter': {},
             ...
             'index': [{'clustered': False,
                        ...
                        'unique': False},
                       {'clustered': True,
                        'columns': ['delete_date', 'create_date'],'detailed_columns': [{'name': 'delete_date',
                                              'nulls': 'LAST',
                                              'order': 'ASC'},
                                             {'name': 'create_date',
                                              'nulls': 'LAST',
    ...
    expected = [
        {
            ...
            "index": [
              ...
              'detailed_columns': [{'name': 'pipeline_id',
                                    'nulls': 'LAST',
                                    'order': 'ASC'},
                                   {'name': 'elapse_time',
                                    'nulls': 'LAST',
    ...
    expected = [
        {
            ...
            "checks": [],
            "index": [
                {"index_name": "pipeline_pk", "unique": True, 'detailed_columns': [{'name': 'job_id',
                                    'nulls': 'LAST',
                                    'order': 'ASC'}],"columns": ["job_id"]},
                {
                    "index_name": "pipeline_ix2",
                    "unique": False,
                    "columns": ["pipeline_id", "elapse_time", "status"],
