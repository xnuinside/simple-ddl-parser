...
def test_alter_unique():
   ...
   result = DDLParser(ddl).run(group_by_type=True)
   expected = {'sequences': [],
 'tables': [{'alter': {'uniques': [{'columns': ['birth_date'],
                                    'constraint_name': None},
                                   {'columns': ['current_funds', 'create_date'],
                                    'constraint_name': 'UC_Person_ening_funds'}]},
             'checks': [{'constraint_name': 'CHK_Person_Age_under',
                         'statement': "days_active<=18 AND user_city='New "
                                      "York'"}],
             'columns': [{'check': None,
                          'default': None,
                          'name': 'id',
                         ...
                         {'check': None,
                          ...
                          'type': 'IMAGE',
                          'unique': False}],
             'constraints': {'checks': [{'constraint_name': 'CHK_Person_Age_under',
                                         'statement': 'days_active<=18 AND '
                                                      "user_city='New York'"}],
                             'references': [{'columns': ['PersonID'],
                                             'constraint_name': 'FK_Person_Age_under',
                                             'deferrable_initially': None,
                                             'on_delete': None,
                                             'on_update': None,
